...
import { Card, Table, Button, Typography, message, Space, Tag, Alert } from 'antd';
import { DesktopOutlined, MobileOutlined, TabletOutlined, DeleteOutlined } from '@ant-design/icons';
