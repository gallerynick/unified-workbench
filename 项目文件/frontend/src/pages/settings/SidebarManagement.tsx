...
const DEFAULT_ITEMS: SidebarItem[] = [
  ...
  { key: '/tasks', label: '任务', icon: 'CheckSquareOutlined', visible: true, hasData: false, builtin: true },
  { key: '/contacts', label: '通讯录', icon: 'ContactsOutlined', visible: true, hasData: false, builtin: true },
  { key: '/calendar', label: '日历', icon: 'CalendarOutlined', visible: true, hasData: false, builtin: true },
  { key: '/votes', label: '投票', icon: 'LikeOutlined', visible: true, hasData: false, builtin: true },
  { key: '/forms', label: '表单', icon: 'FormOutlined', visible: true, hasData: false, builtin: true },
  { key: '/members', label: '成员', icon: 'TeamOutlined', visible: true, hasData: false, builtin: true },
  { key: '/announcements', label: '公告', icon: 'SoundOutlined', visible: true, hasData: false, builtin: true },
  { key: '/notes', label: '笔记', icon: 'BookOutlined', visible: true, hasData: false, builtin: true },
  { key: '/files', label: '文件', icon: 'FileOutlined', visible: true, hasData: true, builtin: true },
  { key: '/content', label: '内容', icon: 'FileTextOutlined', visible: true, hasData: true, builtin: true },
  { key: '/projects', label: '项目', icon: 'ProjectOutlined', visible: true, hasData: true, builtin: true },
  { key: '/inventory', label: '库存', icon: 'AppstoreOutlined', visible: true, hasData: false, builtin: true },
  { key: '/finance', label: '财务', icon: 'MoneyCollectOutlined', visible: true, hasData: false, builtin: true },
  { key: '/secrets', label: '密钥', icon: 'KeyOutlined', visible: true, hasData: true, builtin: true },
  { key: '/reminders', label: '提醒', icon: 'BellOutlined', visible: true, hasData: true, builtin: true },
  { key: '/topology', label: '拓扑', icon: 'ApartmentOutlined', visible: true, hasData: false, builtin: true },
];
