# topology-category-refactor - Work Plan
...
- Evidence: .omo/evidence/task-<N>-topology-category-refactor.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-topology-category-refactor.<ext>
